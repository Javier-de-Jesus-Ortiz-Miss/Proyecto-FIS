...
1. [Registrar un nuevo usuario](#uc01-registrar-un-nuevo-usuario)
2. [Ingresar a la cuenta de un usuario](#uc02-ingresar-a-la-cuenta-de-un-usuario)
3. [Ver e interactuar con videos subidos por otros usuarios](#uc03-ver-videos-subidos-por-otros-usuarios)
4. [Hacer match con un usuario  deslizando a la derecha al ver un video en la página principal](#uc04-hacer-match-con-un-usuario-deslizando-a-la-derecha-al-ver-un-video-en-la-página-principal)
5. [Acceder al perfil de un usuario seleccionando la foto de perfil al ver un video en la página principal](#uc05-acceder-al-perfil-del-usuario-seleccionando-la-foto-de-perfil-al-ver-un-video-en-la-página-principal)
6. [Buscar un usuario](#uc06-buscar-un-usuario)
7. [Visualizar proyectos afines](#uc07-visualizar-proyectos-afines)
8. [Hacer match con un proyecto  deslizando hacia la derecha al visualizarlo en la página principal.](#uc08-hacer-match-con-un-proyecto-deslizando-hacia-la-derecha-al-visualizarlo-en-la-página-principal)
9. [Acceder al perfil de un proyecto, seleccionando la foto de perfil al ver un video en la página principal](#uc09-acceder-al-perfil-de-un-proyecto-seleccionando-la-foto-de-perfil-al-ver-un-video-en-la-página-principal)
10. [Buscar un proyecto](#uc10-buscar-un-proyecto)
11. [Crear un nuevo proyecto](#uc11-crear-un-nuevo-proyecto)
12. [Ver contenido del perfil personal](#uc12-ver-contenido-del-perfil-personal)
13. [Eliminar contenido de mi perfil](#uc13-eliminar-contenido)
14. [Hacer contenido favorito para que se muestre a otros usuarios en la sección principal](#uc14-hacer-contenido-favorito-para-que-se-muestre-a-otros-usuarios-en-la-sección-principal)
15. [Subir un nuevo contenido (Video)](#uc15-subir-un-nuevo-contenido)
16. [Ver Informacion personal](#uc16-ver-informacion-personal)
17. [Personalizar perfil personal](#uc17-personalizar-perfil-cambiar-orden)
18. [Ver Proyectos en los que el usuario participa](#uc18-ver-proyectos-en-los-que-el-usuario-participa)
19. [Editar proyectos en los que el usuario es el líder](#uc19-editar-proyectos-en-los-que-el-usuario-es-el-líder)
20. [Ver los contactos personales](#uc20-ver-los-contactos-personales)
21. [Interactuar en un chat personal](#uc21---interactuar-en-un-chat-personal)
22. [interactuar un chat grupal](#uc22---interactuar-en-un-chat-grupal)
23. [Editar un chat grupal](#uc23-editar-un-chat-grupal)
24. [Aceptar una solicitud de match](#uc24---aceptar-una-solicitud-de-match)
25. [Aceptar solicitud de match a un proyecto](#uc25---aceptar-solicitud-de-match-a-un-proyecto)
26. [Dar match a un usuario](#uc26-dar-match-a-un-usuario)
27. [Dar match a un proyecto](#uc27-dar-match-a-un-proyecto)
28. [Visualizar el contenido del perfil de un usuario](#uc28-visualizar-el-contenido-del-perfil-de-un-usuario)
29. [Visualizar la descripción de un usuario](#uc29-visualizar-la-descripción-de-un-usuario)
30. [Visualizar los proyectos de un usuario](#uc30-visualizar-los-proyectos-de-un-usuario)
31. [Visualizar los contactos  de un usuario](#uc31-visualizar-los-contactos-de-un-usuario)
...
|                 |                     |                  |
| ---------------- | ------------------- | ---------------- |
| **Descripción**  | Este caso de uso permite al usuario subir un nuevo contenido a su perfil |
| **Precondición** |El usuario ha iniciado sesión en su cuenta |
| **Secuencia Normal** | 1. El usuario se encuentra en la sección principal. |
||2. El usuario selecciona el icono del usuario ubicado en el menú inferior a la derecha. |
| |3. El sistema abre la ventana del perfil en la sección de contenido. |
...
|| 3. En la sección "About me" del perfil, el usuario puede ver información como la ciudad, curriculum, generos musicales, interes, etc.|
...
## UC20 Ver los contactos personales
...
| **Excepciones** | Paso 2- El usuario 2 ya había mandado una solicitud de match sl usuario 1 |
||2.1. El usuario 1 selecciona la opcion de "Match" |
||2.2. El sistema abre la seccion de chat en el chat del usuario 2 |
